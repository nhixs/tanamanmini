...
<head>
	...
	<!-- Main CSS -->
	<link type="text/css" rel="stylesheet" href="frontend/css/main.css" />
...
<body>
			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-logo">
						<a class="logo" href="index.php">
							<img src="./gambar/sistem/WhatsApp Image 2021-03-21 at 10.17.14.jpeg" alt="" style="width: 100px">
						</a>
					</div>
					<!-- /Logo -->
					...
					<div class="header-search">
						<form action="" method="get">
							<input class="input searchBar" type="text" name="cari" placeholder="Masukkan Pencarian ..">
				...
				<div class="pull-right">
					<ul class="header-btns">
						...
						<!-- Mobile nav toggle-->
						<li class="nav-toggle visible-xs">
							...
							<div class="custom-menu">
								<div id="shopping-cart">
									...
									<div class="shopping-cart-btns">
										<a class="main-btn hidden-xs" href="keranjang.php">Keranjang <i class="fa fa-arrow-circle-right"></i></a>
										<a class="primary-btn hidden-xs" href="checkout.php">Checkout <i class="fa fa-arrow-circle-right"></i></a>
									</div>
								</div>
							</div>
						</li>
						<li>
							<div class="row visible-xs" style="margin-left: 5em;">
								<a class="main-btn col-xs-6" style="width: 8.5em; margin-bottom: 1em;" href="keranjang.php">Keranjang</i></a>
								<br>
								<a class="primary-btn col-xs-6" style="width: 8.5em;" href="checkout.php">Checkout <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</li>
						<!-- /Cart -->
						...
						?>
							<!-- Account -->
							<li class="header-account dropdown default-dropdown hidden-xs" style="min-width: 200px">
						...
						?>
							<li class="header-account dropdown default-dropdown">
								<a href="masuk.php" class="text-uppercase main-btn login-btn">Login</a>
								<a href="daftar.php" class="text-uppercase primary-btn signup-btn">Daftar</a>
							</li>
						<?php
						}
						?>
		...
		<div class="container">
			<div id="responsive-nav">
				...
				<div class="menu-nav">
					...
					<ul class="menu-list">
						<li><a class="shopLink" href="index.php">Shop</a></li>
					</ul>
				</div>
				<!-- menu nav -->
				<div class="menu-nav visible-xs">
					<span class="menu-header" id="menu-arrow" class="btn video-icon"><?php echo $c['customer_nama']; ?> (<?php echo $c['customer_email']; ?>) <i class="fa fa-arrow-down"></i></span>
					<ul class="menu-list">
						<li><a href="customer.php"><i class="fa fa-user-o"></i> Akun Saya</a></li>
						<li><a href="customer_pesanan.php"><i class="fa fa-list"></i> Pesanan Saya</a></li>
						<li><a href="customer_password.php"><i class="fa fa-lock"></i> Ganti Password</a></li>
	...
	<script>
		$('#menu-arrow').click(function() {
			$(this).find('i').toggleClass('fa fa-arrow-right').toggleClass('fa fa-arrow-down');
		});
	</script>