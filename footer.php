			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="./gambar/sistem/WhatsApp Image 2021-03-21 at 10.17.14.jpeg" alt="Tanaman Mini logo">
						</a>
					</div>
					<!-- /footer logo -->

					<p>Toko online tanaman mini indonesia.</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<ul class="footer-social">
						...
						<li><a href="https://www.instagram.com/tanamanmini/"><i class="fa fa-instagram"></i></a></li>
